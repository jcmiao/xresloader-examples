...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_xresloader_2eproto = {
  false, false, 988, descriptor_table_protodef_xresloader_2eproto, "xresloader.proto", 
  ...
  file_level_metadata_xresloader_2eproto, file_level_enum_descriptors_xresloader_2eproto, file_level_service_descriptors_xresloader_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK ::PROTOBUF_NAMESPACE_ID::Metadata
descriptor_table_xresloader_2eproto_metadata_getter(int index) {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_xresloader_2eproto);
  return descriptor_table_xresloader_2eproto.file_level_metadata[index];
}
