...
#ifndef CONFIG_EXCEL_CONFIG_SET__CONFIG_SET_QUESTS_CFG_H
#define CONFIG_EXCEL_CONFIG_SET__CONFIG_SET_QUESTS_CFG_H
...
namespace excel {
    ...
    class config_set_quests_cfg {
    public:
        typedef const ::quests_cfg item_type;
        typedef ::quests_cfg proto_type;
        typedef std::shared_ptr<item_type> item_ptr_type;

    public:
        config_set_quests_cfg();
        ~config_set_quests_cfg();
...
#endif // CONFIG_EXCEL_CONFIG_SET__CONFIG_SET_QUESTS_CFG_H
